...
export default function KartuPinjamanPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Use DB installments if available, otherwise generate on-the-fly
      if (data.installments && data.installments.length > 0) {
        setInstallments(data.installments);
      } else if (data.loan) {
        // Generate schedule on-the-fly for loans without stored installments
      ...
      <div ref={printRef} className="bg-white rounded-2xl shadow-sm print:shadow-none print:rounded-none">
        ...
        <div className="border-b border-gray-200 p-6 print:p-4">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-teal-100 flex items-center justify-center print:hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-3 text-sm">
            ...
            <div>
              <p className="text-[11px] text-gray-400 uppercase tracking-wide">Pagu Pinjaman</p>
