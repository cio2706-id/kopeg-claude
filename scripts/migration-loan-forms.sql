-- Migration: Loan form data + channeling type + document URLs
--
...
ALTER TABLE loans ADD COLUMN IF NOT EXISTS document_urls jsonb;
...
-- SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'loans' AND column_name IN ('form_data', 'document_urls');
